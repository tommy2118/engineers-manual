...
3. **With feedback.** You need to know what you did right and wrong. Fast feedback loops.
4. **Repeated.** Once isn't practice. Ten times is getting there. A hundred times is training.
...
**The process:**
1. Identify the habit you want. "I want to write the test first."
2. Make it the path of least resistance. Test file open before implementation file.
3. Create friction for the wrong behavior. If you catch yourself implementing first, stop. Delete it. Write the test.
